...
export const Footer = () => (
  <footer className="bg-flow-ink text-flow-cream py-16 px-6 border-t border-flow-cream/10">
    <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-12">
      ...
      <div>
        <p className="font-sans text-xs uppercase tracking-widest text-flow-yellow mb-4">Lançamento</p>
      ...
      <div>
        <p className="font-sans text-xs uppercase tracking-widest text-flow-yellow mb-4">Contato</p>
    ...
    <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-flow-cream/10 flex justify-between font-sans text-xs uppercase tracking-widest text-flow-cream/40">
      <span>© 2026 flow</span>
